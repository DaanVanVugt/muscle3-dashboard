...
# navigator.clipboard needs a secure context, which localhost (the SSH-forward /
# NoMachine access path) always is.
_COPY_JS = (
    "const el=this;"
    ...
    "navigator.clipboard.writeText(el.dataset.path).then(done);"
)
